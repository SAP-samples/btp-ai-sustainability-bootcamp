...
In case you are going to use the standard (paid) plan for AI Core and AI Launchpad, you can refer to [this branch]([this branch](https://github.com/SAP-samples/btp-ai-sustainability-bootcamp/tree/opensap-standard)) where the same exercises are sized to exploit the full capabilities of these two products.
